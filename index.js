...
Runner.prototype = {
  ...
  gameOver: function () {
    ...
    this.distanceMeter.setHighScore(Math.ceil(this.distanceRan));
...
DistanceMeter.prototype = {
  ...
  setHighScore: function (distance) {
    if (distance) {
      window.highscores.setScore(this.getActualDistance(distance));
    }
    distance = window.highscores.getScore();
